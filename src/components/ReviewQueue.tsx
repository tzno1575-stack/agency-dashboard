      ...
      {pending.length > 0 && (
        <div className="space-y-2 mb-6">
          {pending.map((item) => (
            <div
              key={item.id}
              className="bg-white border border-yellow-500/20 rounded-lg p-3"
            >
              <div className="flex items-start gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  {item.output && (
                    <div className="mt-2 p-2 bg-white rounded text-xs text-gray-500 border border-[#1a1a1a] line-clamp-3">
                      {item.output}
                    </div>
                  )}
      ...
      {done.length > 0 && (
        <div className="space-y-2">
          ...
          {done.map((item) => (
            <div
              key={item.id}
              className={`bg-white border rounded-lg p-3 opacity-60 ${
